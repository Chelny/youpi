...
import { NextPieces, NextPiecesPlainObject } from "@/server/towers/game/next-pieces";
...
import { PowerBar, PowerBarPlainObject } from "@/server/towers/game/power-bar";
...
export interface TableSeatGamePlainObject {
  readonly id: string
  readonly seatNumber: number
...
export class TableSeat {
  ...
  public toGamePlainObject(): TableSeatGamePlainObject {
    return {
      id: this.id,
      seatNumber: this.seatNumber,
